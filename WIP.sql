...
SELECT *
FROM temp_permanent
WHERE bps_claimed_area > bps_eligible_area --Step 2d. Correct bps_claimed_area > land_parcel_area claims?
    ...
    FROM
        (SELECT hapar_id,
         ...
         FROM singles_p
         WHERE land_use_area > land_parcel_area) foo WHERE percent_right < 0.95
